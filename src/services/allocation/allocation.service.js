...
export const createForecast = async(req, res) => {
    ...
    let query = `INSERT INTO customer_forecast 
        ...
        "equipment_type", "tarrif_ref", "commodity", "remarks", "heavy_weight", "forward_console")
        ...
        '${forecast.getCarrierDetails().heavyWeight}', '${forecast.getCarrierDetails().forwardConsol}');`;
